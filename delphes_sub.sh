...
Delphes="/home/jyshin/530SPACE/Delphes/"
...
cd /home/jyshin/CMSSW_8_0_35
eval \`scramv1 runtime -sh\`
cd -

export PYTHIA8=/cvmfs/cms.cern.ch/slc7_amd64_gcc530/external/pythia8/223-mlhled
...
${Delphes}DelphesPythia8 ${Delphes}cards/CMS_PhaseII/CMS_PhaseII_200PU_v03_cus_2.tcl config.cmnd DelPy_\${process}.root
...
transfer_input_files = ${Delphes}cards/CMS_PhaseII/CMS_PhaseII_200PU_v03_cus_2.tcl, /home/jyshin/530SPACE/MinBias_100k.pileup, \$(DATAFile)
